...
- Cache: relevant source contents and cached arrays are cryptographically fingerprinted; array shape, dtype, size, and content are checked before reuse.
...
- All 66 tests predating the final relative-time boundary patch remain passing; the complete suite is 69/69 PASS with 0 skipped.
